          ...
          <CardContent className="p-4 pt-0 space-y-3">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-gray-100">
              <div className="flex items-center space-x-3 sm:space-x-4 text-xs sm:text-sm text-gray-500">
                ...
                {/* Logo y puntos al lado de mensajes */}
                <div className="flex items-center gap-1 ml-2 px-2 py-1 bg-yellow-100 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-yellow-500">
                    ...
                    <text x="12" y="16" textAnchor="middle" fontSize="10" fill="#B45309" fontWeight="bold">★</text>
                  </svg>
                  <span className="font-semibold text-yellow-700 text-xs">{event.puntos || 0}</span>
                </div>
              </div>
