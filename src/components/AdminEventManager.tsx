...
import { Plus, Edit, Trash2, Calendar, MapPin, Users, AlertCircle, CheckCircle, Clock, Eye, EyeOff } from 'lucide-react';
...
const AdminEventManager: React.FC<AdminEventManagerProps> = ({
  currentUser,
  onEventCreated,
  supabaseConnected
}) => {
            ...
            <div className="space-y-4">
              ...
              <Alert className={supabaseConnected ? "border-green-200 bg-green-50" : "border-orange-200 bg-orange-50"}>
                ...
                <AlertDescription className={supabaseConnected ? "text-green-800" : "text-orange-800"}>
                  {supabaseConnected 
                    ? "Conectado a Supabase - El evento se sincronizará automáticamente" 
